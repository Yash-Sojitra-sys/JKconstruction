        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 max-w-5xl mx-auto">
          <div className="md:col-span-1">
            ...
            <div className="text-gray-600 text-base space-y-2">
              <p className="font-semibold text-gray-900 text-lg">Jay Krishna Construction</p>
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-4 text-xl">Company</h4>
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-4 text-xl">Services</h4>
            <ul className="space-y-2 text-base text-gray-600">
          ...
          <div>
            <div className="mb-8">
              <h4 className="font-bold text-gray-900 mb-4 text-xl">Careers</h4>
              <ul className="space-y-2 text-base text-gray-600">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-4 text-xl">Contact</h4>
              <ul className="space-y-2 text-base text-gray-600">
