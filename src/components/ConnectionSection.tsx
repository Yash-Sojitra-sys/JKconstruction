...
const ConnectionSection = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-16">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1769bc] mb-6 text-left leading-tight">Connection with Intention</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-gray-200 hover:shadow-xl transition-shadow min-h-[380px] flex flex-col">
          <h3 className="text-2xl sm:text-3xl font-semibold text-[#1769bc] mb-8 mt-8 text-center">Safety</h3>
          ...
          <div className="flex justify-center mt-6 mb-4">
            <button 
              ...
              className="bg-[#1769bc] text-white px-3 py-2 rounded-full flex items-center hover:bg-[#0f5aa3] transition-colors inline-flex whitespace-nowrap text-sm sm:text-base"
            >
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-gray-200 hover:shadow-xl transition-shadow min-h-[380px] flex flex-col">
          <h3 className="text-2xl sm:text-3xl font-semibold text-[#1769bc] mb-8 mt-8 text-center">People</h3>
          <p className="text-base sm:text-lg text-gray-500 mb-8 leading-8 flex-grow px-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-gray-200 hover:shadow-xl transition-shadow min-h-[380px] flex flex-col">
          <h3 className="text-2xl sm:text-3xl font-semibold text-[#1769bc] mb-8 mt-8 text-center">Our Reach</h3>
          <p className="text-base sm:text-lg text-gray-500 mb-8 leading-8 flex-grow px-4">
